                ...
                <div class="single_post_content">
                  ...
                  <ul class="business_catgnav wow fadeInDown">
                    <li>
                      <figure class="bsbig_fig">
                        <a href="single_page.html" class="featured_img">
                            <img alt="img" src="<?php echo base_url('res/home');?>/img/featured_img2.jpg">
                            <span class="overlay"></span>
                        </a>
                        <figcaption>
                          <a href="single_page.html">Proin rhoncus consequat nisl eu ornare mauris</a>
                  ...
                  <ul class="business_catgnav">
                    <li>
                      <figure class="bsbig_fig wow fadeInDown">
                        <a href="single_page.html" class="featured_img">
                            <img alt="img" src="<?php echo base_url('res/home');?>/img/featured_img3.jpg">
                            <span class="overlay"></span>
                        </a>
                        <figcaption>
                          <a href="single_page.html">Proin rhoncus consequat nisl eu ornare mauris</a>
              ...
              <ul class="photograph_nav  wow fadeInDown">                
                <li>
                  <div class="photo_grid">
                    ...
                    <img src="<?php echo base_url('res/home');?>/img/photograph_img2.jpg" alt="img06"/></a>  
                    </figure>
                  </div>
                </li>
                <li>
                  <div class="photo_grid">
                    ...
                    <a class="fancybox-buttons" data-fancybox-group="button" href="img/photograph_img3.jpg" title="Photography Ttile 2">
                      <img src="<?php echo base_url('res/home');?>/img/photograph_img3.jpg" alt="img06"/>
                      </a>  
                    </figure>
                  </div>
                </li>
                <li>
                  <div class="photo_grid">
                    ...
                    <a class="fancybox-buttons" data-fancybox-group="button" href="img/photograph_img4.jpg" title="Photography Ttile 3">
                      <img src="<?php echo base_url('res/home');?>/img/photograph_img4.jpg" alt="img06"/>
                      </a>                        
                    </figure>
                  </div>
                </li>
                  ...
                  <div class="photo_grid">
                    <figure class="effect-layla">
                     <a class="fancybox-buttons" data-fancybox-group="button" href="img/photograph_img2.jpg" title="Photography Ttile 5">
                        <img src="<?php echo base_url('res/home');?>/img/photograph_img2.jpg" alt="img06"/>
                      </a>                          
                    </figure>
                  </div>
                </li>
                  ...
                  <li>
                    <figure class="bsbig_fig  wow fadeInDown">
                      <a class="featured_img" href="single_page.html">
                          <img src="<?php echo base_url('res/home');?>/img/featured_img1.jpg" alt="img">
                          <span class="overlay"></span>
                      </a>
                      <figcaption>
                        <a href="single_page.html">Proin rhoncus consequat nisl eu ornare mauris</a>
